...
<script
	src="${pageContext.request.contextPath}/resources/tp/picker.time.js"></script>
...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/address/css/jquery.address-suggest.css">
<!-- <script src="//code.jquery.com/jquery.min.js"></script> -->
<script
	src="${pageContext.request.contextPath}/resources/address/js/jquery.address-suggest.js"></script>
...
<%-- <link
	...
	rel="stylesheet" /> --%>
<link
	href="${pageContext.request.contextPath}/resources/Content/dpNumberPicker-2.x-skin.grey-min.css"
	rel="stylesheet" />
...
<script
	src="${pageContext.request.contextPath}/resources/Scripts/jquery.validate.min.js"></script>

<script
	src="${pageContext.request.contextPath}/resources/Scripts/jquery.payment.js"></script>
<script
...
<script
	src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDUTefqhrdeC-OBY_tZcXf-M9OghCh4Vx8&libraries=places&callback=initAutocomplete"
	async defer></script>
 ...
 <body onload="setDay()"> 
	...
	<div class="top_menu" id="top_menu">
		<table cellpadding=0 id="menu"
			...
			<tr class="spaceUnder">
				<td width=8%><img id="logohome"
					src="${pageContext.request.contextPath}/resources/images/delivery22.jpg" /></td>
				<td width=15%><a id="gohome"> <b style="font-size: 30px;">Ace
							Roti </b><br />
				...
				<td>
					<button type="button" id="register" value="Sign Up"
						class="btn btn-danger btn-group-justified" data-toggle="modal"
						data-target="#myModal_register"
						style="width: 80px; height: auto; border-radius: 30px; display: block; margin-left: 20px;">Sign
						Up</button>
				</td>
				<td>
	...
	<div id="div_address" class="div_address"
		...
		<table>
			<tr id="date_time_rest" style="display: none">
				<td>
					<div class="dropdown"
						style="margin-left: 360px; margin-top: 30px; width: 150px">
						<button id="dd_btn11" class="btn dropdown-toggle" type="button"
							style="width: 120px; background-color: #eec591"
				...
				<td>
					<div class="dropdown" id="time"
						style="margin-left: 50px; margin-top: 30px; width: 200px">
						<button id="dd_btn22" class="btn dropdown-toggle" type="button"
							data-toggle="dropdown" style="background-color: #eec591"
							onclick="set_rest_time()">
							Select Time <span class="caret"></span>
						</button>
						<ul id="dd_time_rest" class="dropdown-menu scrollable-menu"
							role="menu" style="width: 200px">
		...
		<!-- <div>
			<table>
				<tr>
					<td><input type="text"
						class="form-control" id="datepicker" placeholder="Order here.." ></td>
	...
	<br />
	<div class="container">
		<div class="modal fade" id="profile_details" role="dialog"
						...
						<div class="col-md-6">
							<div id="account_edit"
								...
								<br /> <br /> <a id="edit_user_details">Edit</a> <a
									...
									data-toggle="modal" data-target="#myModal_reset_password"
									data-dismiss="modal">Reset Password</a>
							</div>
							<br />
							<div id="payment_details"
								...
								<div
									...
									<button type="button" class="btn btn-info"
										style="width: 150px; border-radius: 10px; padding-bottom: 10px; margin-left: 150px;"
	...
	<c:forEach items="${list}" var="list">
		...
		<div class="col-md-4">
			...
			<div class="col-md-10" id="showcart"
				style="display: none; border: 1px solid #c4c4c4; border-radius: 10px;">
				<div class="row">
					<div style="padding-left: 60px; padding-top: 10px;">
						<img
							src="${pageContext.request.contextPath}/resources/images/icon_cart.png" />&nbsp;&nbsp;Your
						Cart is Empty
					</div>
				</div>
				<div class="row">
					<div style="padding-left: 25px; padding-bottom: 10px;">
						...
						<table
							style="margin-bottom: 10px; align-items: left; margin-top: 10px;">
							<tr style="margin-bottom: 10px;">
								<td width=10%></td>
								<td style="font-size: 16px; font-weight: bold; width: 150px">Subtotal</td>
								<td><span id="sales_subtotal"
									style="font-size: 16px; font-weight: bold; float: left;"></span>
								</td>
						...
						<button type="submit" name="Review Your Order" id="review_order"
							...
							class="btn btn-success btn-group-justified">Review Your
							Order</button>
					</div>
				</div>
			</div>
		...
		<div class="col-md-4">
			<div class="col-md-1"></div>
			<div class="col-md-10" id="show_empty_cart"
				style="border: 1px solid #c4c4c4; border-radius: 10px; margin-bottom: 10px;">
				<div class="row">
					<div style="padding-left: 60px; padding-top: 10px;">
						<img
							src="${pageContext.request.contextPath}/resources/images/icon_cart.png" />&nbsp;&nbsp;Your
				...
				<div class="row">
					<div style="padding-bottom: 10px;">
						<img
							src="${pageContext.request.contextPath}/resources/images/shopping_cart_red.png"
	...
	<div class="modal fade" id="myModal_login" role="dialog">
		<div class="modal-dialog">
			...
			<div class="modal-content"
				style="color: black; width: 400px; margin-left: 100px">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal">&times;</button>
					...
					<form action="" name="login" id="login">
						...
						<p style="margin-left: 50px;">
							Don't have an account? <a data-toggle="modal"
								data-target="#myModal_register" data-dismiss="modal"> Create
								Your Account</a>
						</p>
				</div>
				</form>
			...
			<div class="modal-content" style="width: 300px; margin-left: 130px">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
						data-toggle="modal" data-target="#profile_details">&times;</button>
					<h4 class="modal-title" style="margin-left: 50px">Change
						Password</h4>
				</div>
				<div class="modal-body">
					...
					<div class="form-group">
						<label>Current Password</label> <input type="password"
							class="form-control" name="pass_current" id="pass_current">
					</div>

					<div class="form-group">
						<label>New Password</label> <input type="password"
							class="form-control" name="pass_new" id="pass_new">
					</div>

					<div class="form-group">
						<label>Confirm Password</label> <input type="password"
							class="form-control" name="pass_confirm" id="pass_confirm">
					</div>

					<div class="form-group">
						<button class="btn" data-dismiss="modal" aria-hidden="true"
							data-toggle="modal" data-target="#profile_details">Close</button>
						<button class="btn btn-primary" id="pass_modal_save">Save
							changes</button>
					</div>
				</div>
			</div>
					...
					<form action="" name="forgotpass" id="forgotpass">
						<div class="input-group">
							<span class="input-group-addon"><label
								...
								class="form-control" name="forgotpass_email"
								id="forgotpass_email" placeholder="Please Enter your Email">
						</div>
						<br />
						<button type="button" id="submit_forgotpass"
				...
				<div class="modal-body">
					<form action="" name="registration">
						...
						<div class="form-group col-md-6">
							<span style="color: red">*</span><label>First name</label> <input
								type="text" class="form-control" name="firstname" id="firstname">

						</div>
						<div class="form-group col-md-offset-6">
							<span style="color: red">*</span><label>Last name</label> <input
								type="text" class="form-control" name="lastname" id="lastname">
						</div>

						<div class="form-group col-md-6">
							<span style="color: red">*</span><label>Email address</label> <input
								type="text" class="form-control" name="email" id="email">
						</div>
						<div class="form-group col-md-offset-6">
							<span style="color: red">*</span><label>Phone number </label>
							(For Password Reset) <input type="text" class="form-control"
								name="phone" id="phone" maxlength="10"
								onkeypress="return isNumber(event)">
						</div>
						<div class="form-group col-md-6">
							<span style="color: red">*</span><label>Password</label> <input
						...
						<p style="font-size: 14px">
							...
							<a data-toggle="modal" data-target="#myModal_terms_conditions">
								Terms & Conditions </a> and <a data-toggle="modal"
								data-target="#myModal_terms_conditions"> Privacy Policy </a>
						</p>

						<div class="form-group">
							<button type="button" id="submit_registration"
								class="btn btn-success"
					...
					<div class="modal-content" class="col-md-12">
						<div class="modal-header" class="col-md-12">
							...
							<div class="modal-title">
								<div
									style="font-size: 26px; font-weight: 500; padding-bottom: none;"
									name="display1" id="display1"></div>
							</div>
						</div>
						<div class="modal-body">
							...
							<table cellpadding="0">
								<tr>
									<td>
										<p style="font-size: 14px;align=" left" id="display3"></p>
									</td>
									<td>
										<h4 style="height: 300px; width: 300px" id="display4"></h4>
									</td>
								</tr>
							</table>
						</div>
					...
					<div class="modal-content" class="col-md-12">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal"
								aria-hidden="true">&times;</button>
							<div class="modal-title">
								<div class="col-md-12" name="display1" id="display1"></div>
							</div>
						</div>
						<div class="modal-body col-md-12" style="color: steelblue;">
							...
							<div class="col-md-6" id="display4" name="display4"></div>

						</div>
						<div class="modal-footer col-md-12" id="updatecart">
							<div class="col-md-3 col-md-offset">
								<button type="button" id="qtyminus2" field="item_qty"
									class="glyphicon glyphicon-minus-sign btn btn-group-justified btn-danger"></button>
								<input type="text" name="item_qty" id="qty2" value="1" />
								<button type="button" id="qtyplus2" field="item_qty"
									class="glyphicon glyphicon-plus-sign btn btn-group-justified btn-success"></button>
							</div>
							<div class="col-md-9">
								<button type="submit" style="height: 45px;" name="updatetocart"
									id="update_qtycart" field="item_qty"
									class="btn btn-success btn-group-justified col-md-push-5"
	...
	<div class="modal fade" id="myModal_payment" role="dialog">
		<div class="modal-dialog">
			...
			<div class="modal-content" style="width: 480px; height: 300px">
				<div class="modal-body">
					<button type="button" class="close" data-dismiss="modal">&times;</button>
					<h4 class="modal-title" align="center" style="color: black">
						<b>My Payment Details</b>
					</h4>
					<span>
						<div class="form-group">
							<input id="cc-number" type="tel" class="form-control cc-number"
								autocomplete="cc-number" placeholder="Card Number"
								onkeyup="ValidateCreditCardNumber()"
						...
						<div class="form-group">
							<input id="cc-exp" type="tel" class=" form-control cc-exp"
								...
								onkeyup="ValidateCreditCardNumber()"
								style="width: 85px; float: left; margin-left: 12px; margin-bottom: 10px"
								required>
						</div>
						<div class="form-group">
							<input id="cc-cvc" type="tel" class="form-control cc-cvc"
								...
								onkeyup="ValidateCreditCardNumber()"
								style="width: 80px; float: right; margin-left: 8px; margin-bottom: 10px"
								required>
						</div> <br /> <br />
					</span>
					<div class="form-group">
						...
						<input type="text" id="cc-name" class="form-control"
							...
							style="width: 438px; margin-bottom: 5px;" />
					</div>
					<div class="form-group">
						<input type="text" id="cc-address" class="form-control"
							placeholder="Billing Address"
							style="width: 215px; float: left; margin-bottom: 10px" />
					</div>
					<div class="form-group">
						<input type="text" id="cc-city" class="form-control"
							placeholder="City"
							style="width: 215px; float: right; margin-bottom: 10px" />
					</div>
					<div class="form-group">
						<input type="text" id="cc-state" class="form-control"
							placeholder="State"
							style="width: 215px; float: left; margin-bottom: 15px;" />
					</div>
					<div class="form-group">
        ...
        <div class="modal-footer">-->
					<div class="form-group">
						<button type="button" id="save_ccard"
							style="width: 210px; display: none; float: left"
							class="btn btn-primary">Save Credit Card</button>
						<button type="button" id="update_ccard"
							style="width: 210px; display: none; float: left"
							class="btn btn-primary">Update Credit Card</button>
						<button type="button" id="submit_card"
							style="width: 210px; display: none; float: left"
							class="btn btn-primary">Add Credit Card</button>
						<button type="button" id="update_card"
							style="width: 210px; display: none; float: left"
							class="btn btn-primary">Update Card</button>
						<button type="button" id="cancel_card"
							style="width: 210px; float: right" class="btn"
				...
				<div class="modal-body">
					...
					<div class="form-group col-md-6">
						<label>First name</label> <input type="text" class="form-control"
							id="edit_firstname" value="" />
					</div>
					<div class="form-group col-md-offset-6">
						<label>Last name</label> <input type="text" class="form-control"
							id="edit_lastname" value="" />
					</div>

					<div class="form-group col-md-6">
						<label>Email address:</label> <input type="text"
							class="form-control" id="edit_email" value="" />
					</div>
					<div class="form-group col-md-offset-6">
						<label>Telephone number:</label> <input type="text"
							class="form-control" id="edit_phone" maxlength="10" value=""
							onkeypress="return isNumber(event)" />
					</div>

					<div class="form-group col-md-6">
						<button type="button" id="save_details" class="btn btn-success"
							style="font-size: 16px; width: 100%; font-weight: bold">
							Update</button>
					</div>

					<div class="form-group col-md-offset-6">
						<button type="button" id="cancel_details" class="btn"
							data-toggle="modal" data-target="#profile_details"
							data-dismiss="modal"
							style="font-size: 16px; width: 100%; font-weight: bold">
							Cancel</button>
					</div>
 ...
 <a style="text-decoration:none;color:black;font-size:16px;cursor: pointer;">  Checkout </a></div>
	...
	<!-- <div class="col-md-12"
		...
		<div class="greybar col-md-12" id="greybar">
			...
			<div class="col-md-8" style="display: none;"
				...
				<a
					style="text-decoration: none; color: black; font-size: 16px; cursor: pointer;"
					id="corp_review_menu_back"> Menu </a>
				<p style="font-size: 18px" class="fa">&#xf054;</p>
				<a
					style="text-decoration: none; color: black; font-size: 16px; cursor: pointer;">
					Checkout </a> <a
					style="text-decoration: none; color: black; font-size: 16px; margin-left: 250px"
					id="corp_review_orderno"></a>
			</div>
  ...
  id="textarea_delivery"></textarea></span>-->
			...
			<div id="review_rest_delivery_details"
				...
				<br /> <label
					style="width: 70px; margin-bottom: 5px; font-weight: lighter">When:</label><label
					style="width: 400px; font-weight: lighter;" align="left"
					id="rest_date_delivery"></label> <br /> <label
					style="width: 70px; margin-bottom: 5px; font-weight: lighter;">Where:</label>
				<label id="rest_address_delivery" style="font-weight: lighter"></label><br />
				<br /> <label
					style="width: 70px; margin-bottom: 5px; font-weight: lighter"><span
					style="color: red">*</span>Name:</label> <input type="text"
					class=" form-control"
					style="width: 300px; display: inline-block; margin-bottom: 5px;"
					id="rest_name_delivery" value="" required /> <label
					style="width: 20px"></label> <label
					style="width: 50px; margin-bottom: 5px; font-weight: lighter"><span
					style="color: red">*</span>Phone:</label> <input type="text"
					class=" form-control"
					style="width: 150px; display: inline-block; margin-bottom: 5px;"
					id="rest_phone_delivery" value="" required /><br /> <br /> <label
					style="width: 400px"></label> <label
					style="width: 50px; margin-bottom: 5px; font-weight: lighter">Email:</label>
				<input type="text" class=" form-control"
					style="width: 150px; display: inline-block; margin-bottom: 5px;"
					id="rest_email_delivery" value="" required /><br /> <br />

				<!--<span><label style="width:70px"></label>
   <textarea placeholder="Special instructions" class="form-control" rows="1" style="width:605px;resize:none; display:inline-block;margin-bottom:5px;" 
  id="textarea_delivery"></textarea></span>-->
				<textarea placeholder="Special instructions" class="form-control"
					rows="1"
			...
			<div id="print_delivery_details"
				style="width: 850px; border: 1px solid #dadada;; padding-left: 10px; margin-bottom: 15px; display: none">
				<h4 style="font-size: 24px; font-family: Times New Roman">
					Delivery Details</h4>
				<br /> <!-- <label
					style="width: 70px; margin-bottom: 5px; font-weight: lighter">When:</label><label
					style="width: 400px;word-break: break-word; font-weight: lighter" align="left"
					id="print_date_delivery"></label> -->
					
					<label
					style="width: 70px; margin-bottom: 5px; font-weight: lighter">When:</label><label
					style="width: 80%;word-wrap: break-word;display: inline-block;margin-left: 13%;margin-bottom: 3%;font-weight: lighter; float: down"
					for="print_date_delivery" id="print_date_delivery" ></label> <br />
					
				<!-- 
					<label
					style="width: 70px; margin-bottom: 5px; font-weight: lighter">When:</label><label
					style="width: 400px;word-break: break-word; font-weight: lighter" align="left"
					id="print_date_delivery"></label> <br />  -->
					
					<label
					style="width: 70px; margin-bottom: 5px; font-weight: lighter">Where:</label><label
					id="print_corp_address_delivery" style="font-weight: lighter"></label><br />
				<label style="width: 70px; margin-bottom: 5px; font-weight: lighter"></label>
				<label id="print_address_delivery" style="font-weight: lighter"></label><br />
				<br /> <label
					style="width: 70px; margin-bottom: 5px; font-weight: lighter">Name:</label>
				<label
					style="width: 300px; display: inline-block; margin-bottom: 5px;"
					id="print_name_delivery" /></label> <label style="width: 20px"></label> <label
					style="width: 50px; margin-bottom: 5px; font-weight: lighter">Phone:</label>
				<label
					style="width: 150px; display: inline-block; margin-bottom: 5px;"
					id="print_phone_delivery"></label><br /> <br /> <label
					style="width: 400px"></label> <label
					style="width: 50px; margin-bottom: 5px; font-weight: lighter">Email:</label>
				<label
					style="width: 150px; display: inline-block; margin-bottom: 5px;"
					id="print_email_delivery" /></label><br /> <br />

				<!--<span><label style="width:70px"></label>
   <textarea placeholder="Special instructions" class="form-control" rows="1" style="width:605px;resize:none; display:inline-block;margin-bottom:5px;" 
  id="textarea_delivery"></textarea></span>-->
				<label
					style="width: 150px; margin-bottom: 5px; font-weight: lighter">Special
					instructions:</label><label id="print_textarea_delivery"
...
<div style=" padding-bottom: 20px;">
		 ...
		 <label style="width:100px;font-weight:lighter;margin-left: 52%;padding-left:10px">Expires</label></h5></div>
	...
	<div class="col-md-6">
		...
		<div id="review_order_summary" style="border:1px solid #dadada;height:auto;margin-bottom:20px;margin-top:-15px;padding-left:10px;width:auto">
			...
			<div style="width:600px;margin-top: 3%;" class="col-md-12">
 ...
 <div class="modal fade" id="orderNoModel" role="dialog">
		...
		<div class="modal fade" id="myModal_dismiss_cart" role="dialog">
			<div class="modal-dialog">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<p>Your cart will be dismissed. Are you sure you want to go to
							the home page?</p>
					</div>

					<div class="modal-footer">

						<button type="button" class="btn btn-success" id="btn_dismiss_yes"
							data-dismiss="modal">Yes</button>
						<button type="button" class="btn btn-danger" id="btn_dismiss_no"
		...
		<div class="modal fade" id="myModal_invalid_datetime" role="dialog">
			<div class="modal-dialog">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<p>The item you have selected is not available for the
							selected time. Do you want to remove the item from cart?</p>
					</div>

					<div class="modal-footer">

						<button type="button" class="btn btn-success"
							id="btn_invalid_time_yes" data-dismiss="modal">Ok</button>
						<button type="button" class="btn btn-danger"
							id="btn_invalid_time_no" data-dismiss="modal">Cancel</button>
					</div>
				</div>
		...
		<div class="modal fade" id="myModal_delete_cc" role="dialog">
			<div class="modal-dialog">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<p>The card will be deleted. Are you sure you would like to
							remove this card?</p>
					</div>
					...
					<div class="modal-footer">
						...
						<button type="button" class="btn btn-success"
							id="btn_delete_cc_yes" data-dismiss="modal">Ok</button>
						<button type="button" class="btn btn-danger" id="btn_delete_cc_no"
							data-dismiss="modal">Cancel</button>
					</div>
				</div>
	...
	<div style="display: none" class="snackbar" id="snackbar_acc_created">Account
		created successfully</div>

	<div style="display: none" class="snackbar" id="snackbar_time">Please
		select Delivery Time</div>
	<div style="display: none" class="snackbar" id="snackbar_date">Please
		select Delivery Date</div>
	<div style="display: none" class="snackbar" id="snackbar_center">Please
		select Corporate center</div>
	<div style="display: none" class="snackbar" id="snackbar_company">Please
		enter Company name</div>
	<div style="display: none" class="snackbar" id="snackbar_suite">Please
		enter Suite number</div>
	...
	<div id="div_footer" class="div_footer" style="display: block">
		<table>
			...
			<tr class="spaceUnder">
				...
				<td><a href="#"
					style="text-decoration: none; color: white; padding-left: 40px"><b>1234567890</b></a></td>
			...
			<tr class="spaceUnder">
				...
				<td><a href="#" class="fa fa-facebook-official"
					style="text-decoration: none; font-size: 26px; width: 60px; padding-left: 50px; color: white">
				</a> <a href="#" class="fa fa-linkedin-square"
					style="text-decoration: none; font-size: 26px; width: 60px; padding-left: 50px; color: white">
				</a> <a href="#" class="fa fa-twitter-square"
					style="text-decoration: none; font-size: 26px; width: 60px; padding-left: 50px; color: white">
			...
			<tr class="spaceUnder">
				<td width=4%></td>
				<td width=10%><a href="/delivery/merchants/"
					style="text-decoration: none; color: white"><b>Merchant
							Page</b></a></td>
			</tr>
