INSERT INTO `RESTAURANT_MENU` VALUES (1, 1, 'Burritoes', 'Fresh kale, apple, pineapple, banana, and pineapple juice.', 'Chipotale/harvestKale-Menu.png', 'ShakeShack/harvestKale-Menu.png', 12);
