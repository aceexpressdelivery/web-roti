...
CREATE TABLE order_items (
  ...
  sales_item_price DOUBLE(4,2) default 0,
  sales_item_tax DOUBLE(4,2) default 0,
  restaurant_item_price DOUBLE(4,2) default 0,
...
CREATE TABLE order_restaurants_menu (
  ...
  PRIMARY KEY (id, CONSTRAINT FK_ORDERID FOREIGN KEY (id) REFERENCES order_items (order_id),
  CONSTRAINT FK_RESTAURANT_ID FOREIGN KEY (order_restaurants_id) REFERENCES order_items (restaurant_id)
);
